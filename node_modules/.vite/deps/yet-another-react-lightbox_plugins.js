import {
  ...
  useSensors,
  useTimeouts
} from "./chunk-OYAT2ZNQ.js";
import "./chunk-PM27OZLH.js";
import {
  __toESM,
  require_react
...
function useZoomSensors(zoom, minZoom, maxZoom, disabled, zoomIn, zoomOut, changeZoom, changeOffsets, zoomWrapperRef) {
  ...
  const pinchZoom = React10.useRef(void 0);
  ...
  augment(({ zoom: zoomProps, toolbar, render, controller, ...restProps }) => {
    ...
    return {
      ...
      render: {
        ...
        slide: (props) => {
          var _a, _b;
          return isImageSlide(props.slide) || props.slide.type != null && ((_a = zoom.supports) === null || _a === void 0 ? void 0 : _a.includes(props.slide.type)) ? React10.createElement(ZoomWrapper, { render, ...props }) : (_b = render.slide) === null || _b === void 0 ? void 0 : _b.call(render, props);
        }
      },
